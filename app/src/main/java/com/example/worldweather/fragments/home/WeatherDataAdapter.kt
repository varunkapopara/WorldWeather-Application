package com.example.worldweather.fragments.home
...
import com.example.worldweather.data.CurrentWeather
import com.example.worldweather.data.Forecast
import com.example.worldweather.data.WeatherData
import com.example.worldweather.databinding.ItemContainerCurrentLocatiionBinding
import com.example.worldweather.databinding.ItemContainerCurrentWeatherBinding
import com.example.worldweather.databinding.ItemContainerForecastBinding
...
class WeatherDataAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            ItemContainerCurrentLocatiionBinding.inflate(
    ...
    inner class CurrentLocationViewHolder(
        private val binding: ItemContainerCurrentLocatiionBinding
    ...
    inner class ForecastViewHolder(
        ...
        fun bind(forecast: Forecast) {
            with(binding) {
                ...
                textTemperature.text = String.format("%s\u0000C", forecast.feelsLikeTemperature)
