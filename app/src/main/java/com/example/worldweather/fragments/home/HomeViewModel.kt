...
import com.example.worldweather.data.LiveDataEvent
...
class HomeViewModel (private val weatherDataRepository: WeatherDataRepository): ViewModel() {
    ...
    private fun getForecastTime(dataTime: String) : String {
        ...
        val data = pattern.parse(dataTime) ?: return dataTime
        return SimpleDateFormat("HH:mm", Locale.getDefault()). format(data)
    }
    //endregion
}
